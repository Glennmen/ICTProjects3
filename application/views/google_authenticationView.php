    ...
    <div id="envelope">
        ...
        <?php }else{ ?>
            <header id="info">
                ...
                <?php echo '<p class="welcome"><i>Welcome ! </i>' . $userData->name . "</p>"; ?></a><a class='logout' href='https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=<?php echo base_url(); ?>index.php/user_authenticationController/logout'>Logout</a>
            </header>
            <?php
